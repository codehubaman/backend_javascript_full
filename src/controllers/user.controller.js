...
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    // when we go to find profile of channel so we get the 
    // username from the url so we use req.params
    ...
    //  to find the user using the username 
    // simply use 
    // User.find({username});

    // but we use aggregation pipelines
